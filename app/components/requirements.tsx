      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-lg space-y-4 leading-8 text-muted-foreground">
          ...
          <ul className="space-y-2 list-disc pl-5">
            <li>Internet access, whether computer or mobile phone.</li>
            <li>Read the terms and conditions of the loan repayment.</li>
            <li>Register with your email on our online loan and credit platform, where you will take less than 10 minutes.</li>
            <li>In a few minutes your credit application will be sent online with BRAND.</li>
          </ul>
        </div>
      </div>
    </div>
